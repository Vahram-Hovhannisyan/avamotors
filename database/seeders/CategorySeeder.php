    ...
    public function run(): void
    {
        ...
        $tree = [
            ...
            [
                'name'        => 'Кузов и салон',
                'slug'        => 'body',
                'description' => 'Зеркала, дворники, уплотнители, петли',
                'sort_order'  => 10,
                'children'    => [
                    ['name' => 'Щётки стеклоочистителей', 'slug' => 'wipers',  'description' => 'Передние и задние дворники',        'sort_order' => 1],
                    ['name' => 'Зеркала',                 'slug' => 'mirrors', 'description' => 'Зеркала заднего вида и их элементы', 'sort_order' => 2],
                ],
            ],
